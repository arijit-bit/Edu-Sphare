              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    { label: "Teacher Portal",  href: `/${schoolSlug}/teacher/dashboard`,  Icon: Users,         cls: "bg-teal-50 dark:bg-teal-950/30 text-teal-600 dark:text-teal-400 border-teal-200 dark:border-teal-800"     },
