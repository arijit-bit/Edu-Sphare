...
const roles = [
  {
    ...
    href: "/demo-school/student/dashboard",
    icon: GraduationCap,
  ...
  },
  {
    ...
    href: "/demo-school/teacher/dashboard",
    icon: Users,
  ...
  },
  {
    ...
    href: "/demo-school/finance/dashboard",
    icon: BarChart3,
  ...
  },
  {
    ...
    href: "/demo-school/admin/dashboard",
    icon: Shield,
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <Button variant="outline" size="lg" asChild>
                <Link href="/demo-school">Go to Demo Portal</Link>
              </Button>
            </div>
          </div>
        </section>
