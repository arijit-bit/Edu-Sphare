...
import {
  ...
  MessageSquare, Settings, Bell, Sun, Moon, Laptop, Menu,
  LogOut, ChevronRight, TrendingUp, Clock, CheckCircle2,
  AlertTriangle, BarChart2, FileText, GraduationCap, Plus
} from "lucide-react";
...
const navItems = [
  { label: "Dashboard",   href: "/teacher/dashboard", icon: LayoutDashboard, short: "Home"     },
  { label: "My Classes",  href: "#",                  icon: BookOpen,        short: "Classes"  },
  { label: "Timetable",   href: "#",                  icon: Calendar,        short: "Schedule" },
  { label: "Assignments", href: "#",                  icon: ClipboardList,   short: "Tasks"    },
  { label: "Students",    href: "#",                  icon: Users,           short: "Students" },
  { label: "Messages",    href: "#",                  icon: MessageSquare,   short: "Chat"     },
  { label: "Settings",    href: "#",                  icon: Settings,        short: "Settings" },
];
          ...
          return (
            <Link key={item.href + item.label} href={item.href}
              className={cn("flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors",
                active ? "bg-teal-600 text-white" : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"
              )}>
      ...
      <div className="border-t p-3">
        <div className="flex items-center gap-3 rounded-lg bg-muted/50 px-3 py-2.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold truncate">Rahul Iyer</p>
            <p className="text-xs text-muted-foreground truncate">Mathematics · HOD</p>
          </div>
